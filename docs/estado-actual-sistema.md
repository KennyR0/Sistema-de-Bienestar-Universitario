...
- Se creó un adaptador técnico de persistencia local para leer y escribir colecciones versionadas en el navegador.
...
- Las altas, ediciones y eliminaciones se conservan automáticamente entre sesiones del navegador.
...
## Persistencia técnica local

La práctica conserva los datos en el almacenamiento del navegador mediante un adaptador interno. Si el usuario limpia los datos del navegador, el sistema vuelve a cargar los datos semilla. Si existe información inválida en una clave técnica, el adaptador recupera la colección semilla y la vuelve a guardar.
